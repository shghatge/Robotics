...
if __name__ == '__main__':
    proc = subprocess.Popen ("roscore", shell = True, stdin = None, stdout = None, stderr = None, close_fds = True)
    time.sleep(5)
    proc1 = subprocess.Popen ("rosrun rviz rviz -d \'rospack find rbx1_nav\'/sim.rviz", shell = True, stdin = None, stdout = None, stderr = None, close_fds = True)
    time.sleep(5)
    try:
        OutAndBack()
    except:
